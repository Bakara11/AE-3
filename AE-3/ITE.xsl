            ...
            <body>
                ...
                <nav class="collapsable-menu">
                    ...
                    <div class="menu-content">
                        <ul class="lista-menu">
                            ...
                            <li class="menulink" id="equipo"> <a href="equipo.html">Nuestro equipo</a> </li>
                ...
                <section>
                    ...
                    <article class="cfgs descripcion">
                        <h3>Además, ahora podrás hacerlo cursando titulaciones oficiales en CFGS de la rama informática. En colaboración con UNIR</h3>
                        <table>
                            <thead>
                                <tr>
                                    <th class="colh1">Denominación</th>
                                    <th class="colh2">Nombre Grado FP</th>
                    ...
                    <article class="descripcion equipo">
                        ...
                        <p>Entre nuestro equipo de docentes con una amplia experiencia laboral
                          y academica, las cuales te ayudarán durante todo el camino de tu formación:</p>
                        <p>Serán<xsl:for-each select="ite/profesores/profesor">
                            , <span class="negrita"><xsl:value-of select="nombre"/></span>
                        </xsl:for-each>Seran ellos los que te formen en el arduo camino de la informatica,
                        aunque desees cambiarlo por un CGS de cocina japonesa.</p>
                        <table>
                    ...
                    <article class="descripcion formulario">
                        ...
                        <form method="get" action="mailto:midireccion@decorreo.es">
                            <fieldset><legend>¡Adelante!</legend>
